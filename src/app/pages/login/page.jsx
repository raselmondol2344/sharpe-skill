  ...
  return (
    <div>
      <div className="min-h-screen flex items-center justify-center bg-default-50/50 px-4 py-12">
        <Card className="w-full max-w-md p-6 sm:p-8 shadow-large bg-sky-300 rounded-2xl border border-gray-300 shadow shadow-stone-300">
          ...
          <Form className="flex w-full flex-col gap-5" onSubmit={onSubmit}>
            ...
            <div>
               <p className="text-center">you have not any account , <span className="text-blue-600"><Link  href={'/pages/signup'}>signup</Link></span></p>
